    ...
    m.extend(!0, m.fn.zTree._z, {
        ...
        view: {
            ...
            repairAllChk: function(b, a) {
                if (b.check.enable && b.check.chkStyle === j.checkbox.STYLE)
                    for (var c = b.data.key.checked, d = b.data.key.children, h = f.getRoot(b), i = 0, l = h[d].length; i < l; i++) {
                        var g = h[d][i];
            ...
            repairSonChkDisabled: function(b, a, c, d) {
                if (a) {
                    ...
                    if (a[h] && d)
                        for (var i = 0, l = a[h].length; i < l; i++) e.repairSonChkDisabled(b, a[h][i], c, d)
                }
            },
            ...
            makeChkFlag: function(b, a) {
                if (a) {
                    var c = b.data.key.children,
                        ...
                        h = -1;
                    if (a[c])
                        for (var i = 0, e = a[c].length; i < e; i++) {
                            var g = a[c][i],
                                f = -1;
                            if (b.check.chkStyle == j.radio.STYLE)
                                if (f = g.nocheck === !0 || g.chkDisabled === !0 ? g.check_Child_State : g.halfCheck === !0 ? 2 : g[d] ? 2 : g.check_Child_State > 0 ? 2 : 0, f == 2) {
                                    h = 2;
                                    break
                                } else f == 0 && (h = 0);
                                else if (b.check.chkStyle == j.checkbox.STYLE)
