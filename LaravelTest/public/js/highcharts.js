...
(function() {
    ...
    var v, z = document,
        ...
        Va, hb = z.documentElement.ontouchstart !== v,
        Pb = {}, yb = 0,
        cb, M, Xa, Da, zb, H, ya = function() {}, Fa = [],
        Ca = "div",
        S = "none",
        ...
        ta = "year",
        Rb = "stroke-width",
        bb, ob, pb, rb, Sa, $a, ab, Fb, Gb, qb, Hb, Ib, aa = {};
    ...
    var pa = function(a) {
        ...
        (function(a) {
            ...
            ] : (c = /#([a-fA-F0-9]{2})([a-fA-F0-9]{2})([a-fA-F0-9]{2})/.exec(a)) ? b = [A(c[1], 16), A(c[2], 16), A(c[3], 16), 1] : (c = /rgb\(\s*([0-9]{1,3})\s*,\s*([0-9]{1,3})\s*,\s*([0-9]{1,3})\s*\)/.exec(a)) && (b = [A(c[1]), A(c[2]), A(c[3]), 1])
        })(a);
        return {
            get: function(c) {
                var f;
    ...
    va.prototype = {
        ...
        attr: function(a, b) {
            ...
            if (ea(a)) c = a, h === "circle" ? c = {
                x: "cx",
                y: "cy"
            }[c] || c : c === "strokeWidth" && (c = "stroke-width"), q = w(g, c) || this[c] || 0, c !== "d" && c !== "visibility" && (q = parseFloat(q));
            else {
                for (c in a)
                    if (j = !1, d = a[c], e = k[c] && k[c].call(this, d, c), e !== !1) {
                        ...
                        if (c === "d") d && d.join && (d = d.join(" ")), /(NaN| {2}|^$)/.test(d) && (d = "M 0 0");
                            ...
                            for (e = 0; e < g.childNodes.length; e++) f = g.childNodes[e], w(f, "x") === w(g, "x") &&
                                w(f, "x", d);
                        ...
                        else if (c === "title") e = g.getElementsByTagName("title")[0], e || (e = z.createElementNS(xa, "title"), g.appendChild(e)), e.textContent = d;
                        c === "strokeWidth" &&
                            (c = "stroke-width");
        ...
        css: function(a) {
            ...
            $ && c && delete a.width;
            if (ra && !Z) c && delete a.width, L(this.element, a);
            else {
        ...
        add: function(a) {
            ...
            if (c.handleZ)
                for (c = 0; c < e.length; c++)
                    if (a = e[c], b = w(a, "zIndex"), a !== f && (A(b) > g || !t(g) && t(b))) {
                        d.insertBefore(f, a);
                        h = !0;
                        break
                    }
    ...
    Ga.prototype = {
        ...
        buildText: function(a) {
            ...
            n(e, function(e, f) {
                ...
                n(m, function(e) {
                    if (e !== "" || m.length === 1) {
                        var o = {}, n = z.createElementNS(xa, "tspan"),
                            r;
                        g.test(e) &&
                        ...
                        if (e !== " " && (n.appendChild(z.createTextNode(e)), p ? o.dx = 0 : o.x = i, w(n, o), !p && f && (!Z && d && L(n, {
                            display: "block"
                        }), w(n, "dy", l || c.fontMetrics(/px$/.test(n.style.fontSize) ? n.style.fontSize : j.fontSize).h, fb && n.offsetHeight)), b.appendChild(n), p++, k))
                            for (var e = e.replace(/([^\^])-/g,
                                "$1- ").split(" "), t, u = []; e.length || u.length;) delete a.bBox, t = a.getBBox().width, o = t > k, !o || e.length === 1 ? (e = u, u = [], e.length && (n = z.createElementNS(xa, "tspan"), w(n, {
                                dy: l || 16,
                                x: i
                            }), r && w(n, "style", r), b.appendChild(n), t > k && (k = t))) : (n.removeChild(n.firstChild), u.unshift(e.pop())), e.length && n.appendChild(z.createTextNode(e.join(" ").replace(/- /g, "-")))
                    }
                })
            })
        },
                ...
                if (ea(a)) c = a, q = c === "strokeWidth" || c === "stroke-width" ? this.strokeweight : this[c];
                    ...
                    for (c in a)
                        if (d = a[c], m = !1, e = o[c] && o[c].call(this, d, c), e !== !1 && d !== null) {
                            ...
                            else if (oa(c, ["x", "y", "width", "height"]) !== -1) this[c] = d, c === "x" || c === "y" ? c = {
                                x: "left",
                                y: "top"
                            ...
                            else if (c === "stroke-width" || c === "strokeWidth") f.stroked = d ? !0 : !1, c = "strokeweight", this[c] = d, qa(d) && (d += "px");
                            ...
                            else if (h === "shape" && c === "rotation") this[c] = f.style[c] = d, f.style.left = -u(ca(d * Ua) + 1) + "px", f.style.top = u(W(d * Ua)) + "px";
        ...
        var ma = {
            ...
            color: function(a, b, c, d) {
                ...
                if (i) {
                    ...
                    if (c === "fill")
                        if (i === "gradient") c = m.x1 || m[0] || 0, a = m.y1 || m[1] || 0, o = m.x2 || m[2] || 0, m = m.y2 || m[3] || 0, t = 'angle="' + (90 - R.atan((m - a) / (o - c)) * 180 / Ma) + '"', s();
                        else {
                            var j = m.r,
                                E = j * 2,
                                G = j * 2,
                ...
                } else if (g.test(a) && b.tagName !== "IMG") f = pa(a), h = ["<", c, ' opacity="', f.get("a"), '"/>'], U(this.prepVML(h), null, null, b), j = f.get("rgb");
                else {
    ...
    La.prototype = {
        ...
        render: function(a, b, c) {
            ...
            if (m && r) u === "inside" && (r = -r), d.opposite && (r = -r), b = this.getMarkPath(I, G, r, m * B, g, f), o ? o.animate({
                d: b,
                opacity: c
    ...
    tb.prototype = {
        render: function() {
            ...
            } else return; if (t(u)) d.zIndex = u;
            if (o) q ? o.animate({
                d: q
            }, null, o.onGetPath) : (o.hide(), o.onGetPath = function() {
                o.show()
            });
            else if (q && q.length && (a.svgElem = o = v.path(q).attr(d).add(), s))
            ...
            if (f && t(f.text) && q && q.length && b.width > 0 && b.height > 0) {
                ...
                if (!g) a.label =
                    g = v.text(f.text, 0, 0, f.useHTML).attr({
    ...
    db.prototype = {
        ...
        update: function(a, b) {
            var c = this.chart,
                a = c.options[this.xOrY + "Axis"][this.options.index] = x(this.userOptions,
                    a);
            this.destroy(!0);
            this._addedPlotLB = !1;
            this.init(c, s(a, {
                ...
                if (c.visible || !b.options.chart.ignoreHiddenSeries) {
                    ...
                    if (a.isXAxis) {
                        ...
                        if (t(e))
                            ...
                            else if (a.dataMax < e) a.dataMax = e, a.ignoreMaxPadding = !0
                    }
                }
            })
        },
        ...
        getOffset: function() {
            ...
            if (j || a.isLinked) {
                ...
                for (w in f) f[w].destroy(), delete f[w]; if (o && o.text && o.enabled !== !1) {
        ...
        getLinePath: function(a) {
            ...
            return b.renderer.crispLine(["M", e ? this.left : f, e ? d : this.top, "L", e ?
                b.chartWidth - this.right : f, e ? d : b.chartHeight - this.bottom
            ], a)
        },
        ...
        render: function() {
            ...
            if (y || f)
                if (a.minorTickInterval && !a.categories && n(a.getMinorTickPositions(), function(b) {
                    ...
                    g.length && (n(g.slice(1).concat([g[0]]), function(b, c) {
                        ...
                        if (c % 2 === 0 && b < a.max) l[b] || (l[b] = new tb(a)), s = b + q, w = g[c + 1] !== v ? g[c + 1] + q : a.max, l[b].options = {
                            from: e ? fa(s) : s,
                            to: e ? fa(w) : w,
                            color: o
            ...
            if (p) y = a.getLinePath(p), a.axisLine ? a.axisLine.animate({
                d: y
            ...
            if (l) {
                ...
                for (d = l.length; d--;)
                    if (m = a.series, e = m[d ? "yAxis" : "xAxis"], l[d] && e)
                        if (h = d ? p(a.stackY, a.y) : a.x, e.isLog && (h = na(h)), m.modifyValue && (h = m.modifyValue(h)), e = e.getPlotLinePath(h, 1), this.crosshairs[d]) this.crosshairs[d].attr({
                            d: e,
                            visibility: "visible"
                        });
                        else {
    ...
    vb.prototype = {
        ...
        runPointActions: function(a) {
            ...
            if (d && this.options.tooltip.shared && (!g || !g.noSharedTooltip)) {
                ...
                h = c.length;
                for (i = 0; i < h; i++)
                    if (c[i].visible && c[i].options.enableMouseTracking !== !1 && !c[i].noSharedTooltip && c[i].tooltipPoints.length && (b = c[i].tooltipPoints[k], b.series)) b._dist = O(k - b.clientX), j = C(j, b._dist), e.push(b);
    ...
    wb.prototype = {
        ...
        renderItem: function(a) {
            ...
            if (!u && (a.legendGroup = d.g("legend-item").attr({
                ...
                t.drawLegendSymbol(b, a), a.legendItem = u = d.text(e.labelFormat ? Ba(e.labelFormat, a) : e.labelFormatter.call(a), m ? g + h : -h, b.baseline, v).css(x(a.visible ? i : j)).attr({
                    align: m ? "left" : "right",
                    zIndex: 2
                }).add(a.legendGroup), (v ? u : a.legendGroup).on("mouseover", function() {
                    a.setState("hover");
        ...
        handleOverflow: function(a) {
            var b = this,
                ...
                f = e.y,
                f =
                    c.spacingBox.height + (e.verticalAlign === "top" ? -f : f) - this.padding,
                g = e.maxHeight,
                h = this.clipRect,
                i = e.navigation,
                j = p(i.animation, !0),
        ...
        scroll: function(a, b) {
            ...
            }), e = -C(e * (d - 1), this.fullHeight - e + i) + 1, this.scrollGroup.animate({
                translateY: e
            }), f.attr({
                text: d + "/" + c
    ...
    xb.prototype = {
        ...
        layOutTitles: function() {
            ...
            if (b && (b.css({
                ...
                y: 15
            }, e), !1, "spacingBox"), !e.floating && !e.verticalAlign)) a = b.getBBox().height, a >= 18 && a <= 25 &&
                (a = 15);
            c && (c.css({
                width: (d.width || f) + "px"
            }).align(s({
        ...
        drawChartBox: function() {
            ...
            if (k) f ?
                f.animate(u) : this.plotBackground = b.rect(q, p, n, r, 0).attr({
                    fill: k
    ...
    Q.prototype = {
        ...
        setData: function(a, b) {
            ...
            if (i && m > i) {
                ...
                if (qa(f)) {
                    ...
                    if (o)
                        for (i =
                            0; i < m; i++) d = a[i], j[i] = d[0], k[i] = d.slice(1, o + 1);
                    else
                ...
                for (i = 0; i < m; i++)
                    if (a[i] !== v && (d = {
                        series: this
                    }, this.pointClass.prototype.applyOptions.apply(d, [a[i]]), j[i] = d.x, k[i] = q ? this.toYData(d) : d.y, l[i] = d.z, h && d.name)) h[d.x] = d.name; ea(k[0]) && ja(14, !0);
            this.data = [];
            this.options.data = a;
            this.xData = j;
            this.yData = k;
        ...
        processData: function(a) {
            ...
            if (k && this.sorted && (!j || d > j || this.forceCrop))
                if (a =
                    h.min, h = h.max, b[d - 1] < a || b[0] > h) b = [], c = [];
        ...
        getExtremes: function() {
            ...
            if (!t(d) || !t(c)) {
                for (b = 0; b < i; b++)
                    if (o = g[b], f = h[b], e = f !== null && f !== v && (!a.isLog || f.length || f > 0), o = this.getExtremesFromAll || this.cropped || (g[b + 1] || o) >= m && (g[b - 1] || o) <= l, e && o)
                        if (e = f.length)
                            for (; e--;) f[e] !== null && (j[k++] = f[e]);
                        else j[k++] = f;
                d = p(d, Ia(j));
                c = p(c, ua(j))
            }
        ...
        drawPoints: function() {
            ...
            if (l.enabled || this._hasPointMarkers)
                for (f = b.length; f--;)
                    if (g = b[f], d = P(g.plotX), e = g.plotY, k = g.graphic, i = g.marker || {}, a = l.enabled && i.enabled === v || i.enabled, m = c.isInsidePlot(u(d), e, c.inverted), a && e !== v && !isNaN(e) && g.y !== null)
        ...
        drawDataLabels: function() {
            ...
            if (a.visible && (e.enabled || a._hasPointLabels)) {
                ...
                if (ua(C) === 0 || this.verifyDataLabelOverflow(C)) this.placeDataLabels(), t && g && n(this.points, function(b) {
                    i = b.connector;
                    v = b.labelPos;
                    if ((s = b.dataLabel) && s._pos) G = s._attr.visibility, z = s.connX, E = s.connY, j = k ? ["M", z + (v[6] === "left" ? 5 : -5), E, "C", z, E, 2 * v[2] - v[4], 2 * v[3] - v[5], v[2], v[3], "L", v[4], v[5]] : ["M", z + (v[6] === "left" ? 5 : -5), E, "L", v[2], v[3], "L", v[4], v[5]], i ? (i.animate({
                        d: j
                    }), i.attr("visibility", G)) : b.connector = i =
                        a.chart.renderer.path(j).attr({
                            "stroke-width": g,
